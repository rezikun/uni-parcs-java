...
public class Cell implements Serializable {
    ...
    private static final int[][] quantizationTable = {
            {17*8, 18*8, 24*8, 47*8, 99*8, 99*8, 99*8, 99*8},
            {18*8, 21*8, 26*8, 66*8, 99*8, 99*8, 99*8, 99*8},
            {24*8, 26*8, 56*8, 99*8, 99*8, 99*8, 99*8, 99*8},
            {47*8, 66*8, 99*8, 99*8, 99*8, 99*8, 99*8, 99*8},
