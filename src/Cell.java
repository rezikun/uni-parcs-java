...
public class Cell implements Serializable {
    ...
    private static final int[][] quantizationTable = {
            {17*3, 18*3, 24*3, 47*3, 99*3, 99*3, 99*3, 99*3},
            {18*3, 21*3, 26*3, 66*3, 99*3, 99*3, 99*3, 99*3},
            {24*3, 26*3, 56*3, 99*3, 99*3, 99*3, 99*3, 99*3},
            {47*3, 66*3, 99*3, 99*3, 99*3, 99*3, 99*3, 99*3},
